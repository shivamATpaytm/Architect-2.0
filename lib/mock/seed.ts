...
export function createLeadNurtureProject(): Project {
  ...
  return {
    ...
    previewReady: true,
    generationVersion: 1,
    prompt: "Research inbound leads, draft personalized nurture emails, QA brand tone, and log notes to HubSpot.",
    domain: "lead-nurture",
    activeScreenId: "screen-0-dashboard",
    screens: [
      {
        id: "screen-0-dashboard",
        name: "Dashboard",
        route: "/",
        kind: "dashboard",
        headline: "Lead Nurture",
        subhead: "Research → draft → QA → CRM · via Email + CRM",
        primaryCta: "Run outreach",
        widgets: [
          { type: "stat", label: "Leads queued", value: "128", meta: "Email · CRM" },
          { type: "stat", label: "Drafts ready", value: "34", meta: "this week" },
          { type: "stat", label: "CRM notes", value: "19", meta: "synced" },
          { type: "row", label: "Maya Chen · Northwind", value: "QA pass", meta: "Series B + hiring SDRs" },
          { type: "row", label: "Omar Patel · Cobalt", value: "Drafting", meta: "Opened pricing 3×" },
          { type: "row", label: "Iris Ng · Lattice", value: "Researched", meta: "Spoke at RevSummit" },
        ],
      },
      {
        id: "screen-1-list",
      ...
      },
      {
        ...
        primaryCta: "Run outreach",
        widgets: [
          { type: "card", label: "Context", value: "Inbound lead — research, personalize, QA, CRM note." },
          { type: "badge", label: "Channels", value: "Email · CRM" },
          { type: "form", label: "Next step", value: "Run outreach" },
        ],
      },
      {
        id: "screen-3-compose",
        ...
        kind: "compose",
        headline: "Compose",
        subhead: "Draft for SDRs / AEs",
        primaryCta: "Send draft",
        widgets: [
          { type: "form", label: "To / target", value: "SDRs / AEs" },
          { type: "form", label: "Channel", value: "Email" },
          { type: "form", label: "Draft", value: "Hi — following up on lead nurture for your team…" },
          { type: "badge", label: "Tone", value: "Professional · concise" },
        ],
      },
      {
        id: "screen-4-settings",
        name: "Settings",
        route: "/settings",
        kind: "settings",
        headline: "Settings",
        subhead: "Workspace · connectors · approve rules",
        primaryCta: "Run outreach",
        widgets: [
          { type: "row", label: "Integrations", value: "gmail, hubspot, web-search, slack" },
          { type: "row", label: "Audience", value: "SDRs / AEs" },
